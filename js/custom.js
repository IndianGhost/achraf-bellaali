...
function typer() {
    var win = $(window),
        foo = $('#typer');
    foo.typer(['<h1><span class="iq-font-purple">Software</span> Engineer</h1>', '<h1>Full-stack <span class="iq-font-purple">Developer</span></h1>', '<h1><span class="iq-font-purple">IT</span> lover</h1>']);
